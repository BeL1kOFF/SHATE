...
type
  TClientIDs = class(TFlatSpr)
    ...
    TableUseDiffMargin: TBooleanField;
    TableDiffMargin: TStringField;
    TableContractByDefault: TStringField;
    TableAgrVersion: TIntegerField;
    TableAddresVersion: TIntegerField;
    TableDiscVersion: TIntegerField;
    TablePhone: TStringField;
    TableName: TStringField;
    TableAddresByDefault: TStringField;
    TableAddresDescrByDefault: TStringField;
...
begin
  ...
  //Под тонкого клиента выбор БД
  Table.Active := False;
  Table.DatabaseName := Main.GetCurrentBD;
  Table.Active := True;
