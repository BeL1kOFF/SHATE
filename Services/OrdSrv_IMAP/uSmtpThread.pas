...
type
  ...
  public
    constructor Create(aOwnerService: TOrdServiceIMAP; aMessageList: TThreadList);
  end;
...
constructor TSMTPMessagesThrd.Create(aOwnerService: TOrdServiceIMAP; aMessageList: TThreadList);
begin
...
begin
  ...
  try
    ...
    //            ContentType := 'multipart/mixed; charset=windows-1251';
              ...
              Subject := Client.subj;
              idTextPart.Body.Add(Client.body);
