...
public:
	...
	VARIANT Add(VARIANT& Left, VARIANT& Top, VARIANT& Width, VARIANT& Height, VARIANT& Editable)
	{
		VARIANT result;
		static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT ;
		InvokeHelper(0xb5, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, &Left, &Top, &Width, &Height, &Editable);
		return result;
	}
