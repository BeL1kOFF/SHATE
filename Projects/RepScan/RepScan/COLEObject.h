...
public:
	...
	VARIANT Verb(VARIANT& Verb)
	{
		VARIANT result;
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0x25e, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, &Verb);
		return result;
	}
...
public:
	...
	void SetAutoLoad(VARIANT &propVal)
	{
	...
	void SetAutoUpdate(VARIANT &propVal)
	{
	...
	void SetObject(VARIANT &propVal)
	{
	...
	void SetOLEType(VARIANT &propVal)
	{
