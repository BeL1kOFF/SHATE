...
public:
	...
	VARIANT Add(VARIANT& Button, VARIANT& Before, VARIANT& OnAction, VARIANT& Pushed, VARIANT& Enabled, VARIANT& StatusBar, VARIANT& HelpFile, VARIANT& HelpContextID)
	{
		VARIANT result;
		static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT ;
		InvokeHelper(0xb5, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, &Button, &Before, &OnAction, &Pushed, &Enabled, &StatusBar, &HelpFile, &HelpContextID);
		return result;
	}
	VARIANT Application()
	{
