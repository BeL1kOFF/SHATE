...
public:
	...
	VARIANT Add(VARIANT& Type, VARIANT& Order, VARIANT& Period, VARIANT& Forward, VARIANT& Backward, VARIANT& Intercept, VARIANT& DisplayEquation, VARIANT& DisplayRSquared, VARIANT& Name)
	{
		VARIANT result;
		...
		InvokeHelper(0xb5, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, &Type, &Order, &Period, &Forward, &Backward, &Intercept, &DisplayEquation, &DisplayRSquared, &Name);
		return result;
	}
	VARIANT Application()
	{
