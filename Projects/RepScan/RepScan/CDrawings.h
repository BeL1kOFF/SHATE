...
public:
	...
	VARIANT Add(VARIANT& X1, VARIANT& Y1, VARIANT& X2, VARIANT& Y2, VARIANT& Closed)
	{
		VARIANT result;
		static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT ;
		InvokeHelper(0xb5, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, &X1, &Y1, &X2, &Y2, &Closed);
		return result;
	}
	VARIANT Application()
	{
