...
//#define IDC_INPLACE_CONTROL_COMBO   9 
...
#define GVN_SELECTING 0x4552
#define GVN_APPLYFILTER		12121212
...
// Attributes
public:
	CStringArray *sArrayValues;
	long lSelectItemCombo;
