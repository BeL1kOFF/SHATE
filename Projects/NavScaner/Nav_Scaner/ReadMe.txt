================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Nav_Scaner Project Overview
===============================================================================

The application wizard has created this Nav_Scaner application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Nav_Scaner application.
...
Nav_Scaner.h
    ...
    project specific headers and declares the CNav_ScanerApp application class.

Nav_Scaner.cpp
    This is the main application source file that contains the application
    class CNav_ScanerApp.
...
Nav_ScanerDlg.h, Nav_ScanerDlg.cpp - the dialog
    These files contain your CNav_ScanerDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named Nav_Scaner.pch and a precompiled types file named StdAfx.obj.
