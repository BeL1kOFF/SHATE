================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Nav_Scaner_Assembler Project Overview
===============================================================================

The application wizard has created this Nav_Scaner_Assembler application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Nav_Scaner_Assembler application.

Nav_Scaner_Assembler.vcproj
    This is the main project file for VC++ projects generated using an application wizard. 
    It contains information about the version of Visual C++ that generated the file, and 
    information about the platforms, configurations, and project features selected with the
    application wizard.

Nav_Scaner_Assembler.h
    This is the main header file for the application.  It includes other
    project specific headers and declares the CAssemblerApp application class.

Nav_Scaner_Assembler.cpp
    This is the main application source file that contains the application
    class CAssemblerApp.

Nav_Scaner_Assembler.rc
...
AssemblerDlg.h, AssemblerDlg.cpp - the dialog
    These files contain your CAssemblerDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named Nav_Scaner_Assembler.pch and a precompiled types file named StdAfx.obj.
