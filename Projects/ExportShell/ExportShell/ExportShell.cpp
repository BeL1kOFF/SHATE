// ExportShell.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CExportShellApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CExportShellApp construction

CExportShellApp::CExportShellApp()
{
...
// The one and only CExportShellApp object

CExportShellApp theApp;


// CExportShellApp initialization

BOOL CExportShellApp::InitInstance()
{
