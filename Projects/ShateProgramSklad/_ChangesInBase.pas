...
type
  ...
  TChangesInBase = class(TForm)
    ...
    procedure ChangesTreeInitNode(Sender: TBaseVirtualTree; ParentNode,
      Node: PVirtualNode; var InitialStates: TVirtualNodeInitStates);
    procedure ChangesTreeMeasureItem(Sender: TBaseVirtualTree;
...
procedure TChangesInBase.ChangesTreeInitNode(Sender: TBaseVirtualTree;
  ParentNode, Node: PVirtualNode; var InitialStates: TVirtualNodeInitStates);
begin
 // Include(InitialStates, ivsMultiline);
end;

procedure TChangesInBase.ChangesTreeMeasureItem(Sender: TBaseVirtualTree;
  TargetCanvas: TCanvas; Node: PVirtualNode; var NodeHeight: Integer);
begin
  if Sender.MultiLine[Node] then
  begin
    TargetCanvas.Font := Sender.Font;
    NodeHeight := ChangesTree.ComputeNodeHeight(TargetCanvas, Node, 0) + 10;
  end;
end;
