...
//  iPosDescretUpdate: Integer;
  UpdateData: TUpdateFileData;
  aSectionName, aCurVersion: string;
  IsNewVer: Boolean;
begin
   SetParametrs := TRUE;
...
begin
  ...
  fNeedFullUpdatePicts :=  GetFileSize_Internal(Data.Data_path + '027.3') < 5000000;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          //sklad
          if SameText(Copy(UpdateFileData.localversion, 1, 6), 'quants') then //quants2, quants3 .. quants16
            if (Main.IsQuantsBaseActive( StrToIntDef( Copy(UpdateFileData.localversion, 7, MaxInt), 0))
                ) or (Copy(UpdateFileData.localversion, 8, MaxInt) = 'all') then
              UpdateFileData.basename := UpdateFileData.localversion;
        end;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              if IsNewVer and (pos('140624.', UpdateFileData.customversion)> 0) then
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          UpdateData := Main.ListParametrs.Items[j];
