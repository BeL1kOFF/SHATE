...
uses
  Classes, SysUtils, Windows, Forms, Controls, ADOInt;
...
function StrGetName(const aValue: string; aSeparator: Char = '='): string;
function StrGetValue(const aValue: string; aSeparator: Char = '='): string;
