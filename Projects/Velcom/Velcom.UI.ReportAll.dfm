object frmReportAll: TfrmReportAll
  Left = 0
  Top = 0
  Caption = #1054#1090#1095#1077#1090' '#1087#1086' '#1079#1074#1086#1085#1082#1072#1084
  ClientHeight = 452
  ClientWidth = 909
  Color = clBtnFace
  ...
  object cxGrid: TcxGrid
    ...
    object cxTable: TcxGridDBBandedTableView
      ...
      object colDistributionCost: TcxGridDBBandedColumn
        AlternateCaption = #1048#1079#1076#1077#1088#1078#1082#1080
        Caption = #1048#1079#1076#1077#1088#1078#1082#1080
        DataBinding.FieldName = 'DistributionCost'
